...
/**
 * \file    test/phpunit/EmailcommandeFunctionalTest.php
...
/**
 * Class EmailcommandeFunctionalTest
 *
 ...
 *
 * @package Testemailcommande
 */
class EmailcommandeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEmailcommande')->click();
		} else {
			// Disable the module
			$this->byHref('modEmailcommande')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/emailcommande/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('emailcommande/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/emailcommande/admin/about.php');
		$this->authenticate();
		return $this->assertContains('emailcommande/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('emailcommandewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEmailcommande_EmailcommandeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEmailcommande_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

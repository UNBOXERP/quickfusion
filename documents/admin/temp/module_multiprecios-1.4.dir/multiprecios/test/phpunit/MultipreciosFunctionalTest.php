...
/**
 * \file    test/phpunit/MultipreciosFunctionalTest.php
...
/**
 * Class MultipreciosFunctionalTest
 *
 ...
 *
 * @package Testmultiprecios
 */
class MultipreciosFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMultiprecios')->click();
		} else {
			// Disable the module
			$this->byHref('modMultiprecios')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/multiprecios/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('multiprecios/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/multiprecios/admin/about.php');
		$this->authenticate();
		return $this->assertContains('multiprecios/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('multiprecioswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMultiprecios_MultipreciosTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMultiprecios_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

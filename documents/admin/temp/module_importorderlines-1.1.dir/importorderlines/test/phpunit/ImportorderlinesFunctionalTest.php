...
/**
 * \file    test/phpunit/ImportorderlinesFunctionalTest.php
...
/**
 * Class ImportorderlinesFunctionalTest
 *
 ...
 *
 * @package Testimportorderlines
 */
class ImportorderlinesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modImportorderlines')->click();
		} else {
			// Disable the module
			$this->byHref('modImportorderlines')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/importorderlines/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('importorderlines/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/importorderlines/admin/about.php');
		$this->authenticate();
		return $this->assertContains('importorderlines/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('importorderlineswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modImportorderlines_ImportorderlinesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modImportorderlines_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

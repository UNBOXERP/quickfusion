...
$type = 'product';
$langs->loadLangs(array("multiprecios@multiprecios"));
//alan
$multiprecio_ORDEN1 = GETPOST('multiprecio_ORDEN1', 'alpha');
$multiprecio_ORDEN2 = GETPOST('multiprecio_ORDEN2', 'alpha');
$multiprecio_ORDEN3 = GETPOST('multiprecio_ORDEN3', 'alpha');
$multiprecio_ORDEN4 = GETPOST('multiprecio_ORDEN4', 'alpha');
$multiprecio_ORDEN5 = GETPOST('multiprecio_ORDEN5', 'alpha');
$multiprecio_ORDEN6 = GETPOST('multiprecio_ORDEN6', 'alpha');
$multiprecio_ORDEN7 = GETPOST('multiprecio_ORDEN7', 'alpha');


$arrayofparameters = array(

    'multiprecio_ORDEN1'=>array('css'=>'minwidth200', 'enabled'=>1),
    'multiprecio_ORDEN2'=>array('css'=>'minwidth500', 'enabled'=>1),
    'multiprecio_ORDEN3'=>array('css'=>'minwidth500', 'enabled'=>1),
    'multiprecio_ORDEN4'=>array('css'=>'minwidth500', 'enabled'=>1),
    'multiprecio_ORDEN5'=>array('css'=>'minwidth500', 'enabled'=>1),
    'multiprecio_ORDEN6'=>array('css'=>'minwidth500', 'enabled'=>1),
    'multiprecio_ORDEN7'=>array('css'=>'minwidth500', 'enabled'=>1),
);
...
if ($action == 'other')
{
    ...
    $res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN1')", GETPOST('multiprecio_ORDEN1'), 'chaine', 0, '', $conf->entity);
	$res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN2')", GETPOST('multiprecio_ORDEN2'), 'chaine', 0, '', $conf->entity);
	$res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN3')", GETPOST('multiprecio_ORDEN3'), 'chaine', 0, '', $conf->entity);
	$res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN4')", GETPOST('multiprecio_ORDEN4'), 'chaine', 0, '', $conf->entity);
	$res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN5')", GETPOST('multiprecio_ORDEN5'), 'chaine', 0, '', $conf->entity);
	$res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN6')", GETPOST('multiprecio_ORDEN6'), 'chaine', 0, '', $conf->entity);
	$res = dolibarr_set_const($db, "$langs->trans('multiprecio_ORDEN7')", GETPOST('multiprecio_ORDEN7'), 'chaine', 0, '', $conf->entity);
...
if (!empty($conf->global->PRODUIT_MULTIPRICES) || !empty($conf->global->PRODUIT_CUSTOMER_PRICES_BY_QTY_MULTIPRICES)) {
	print '<tr class="oddeven">';
	print '<td>'.$langs->trans("MultiPricesNumPricesModify").'</td>';
...
/*
 *   MULTIPRECIO ORDEN ALAN
 *
 * */
//
print '<tr class="liste_titre">';
print '<td>'.$langs->trans("ParametersMultiprice").'</td>'."\n";
print '<td class="right" width="60">'.$langs->trans("Value").'</td>'."\n";
print '</tr>'."\n";

print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_1").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN1" value="'.$conf->global->multiprecio_ORDEN1.'"></td>';
print '</tr>';
print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_2").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN2" value="'.$conf->global->multiprecio_ORDEN2.'"></td>';
print '</tr>';
print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_3").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN3" value="'.$conf->global->multiprecio_ORDEN3.'"></td>';
print '</tr>';
print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_4").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN4" value="'.$conf->global->multiprecio_ORDEN4.'"></td>';
print '</tr>';
print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_5").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN5" value="'.$conf->global->multiprecio_ORDEN5.'"></td>';
print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_6").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN6" value="'.$conf->global->multiprecio_ORDEN6.'"></td>';
print '</tr>';
print '<tr class="oddeven">';
print '<td>'.$langs->trans("Selling_price_7").'</td>';
print '<td class="right"><input size="3" type="text" class="flat" name="multiprecio_ORDEN7" value="'.$conf->global->multiprecio_ORDEN7.'"></td>';
print '</tr>';
/*
 *  FIN   MULTIPRECIO ORDEN ALAN
 *
 * */

...
class reportico extends reportico_object
{
    ...
    */
	...
	function initialize_panels($mode)
	{
		...
		$this->prepare_url =  $calling_script."?execute_mode=PREPARE&amp;reportico_session_name=".reportico_session_name()."&amp;token=".newToken();
		$this->menu_url =  $calling_script."?execute_mode=MENU&amp;reportico_session_name=".reportico_session_name()."&amp;token=".newToken();
		$this->admin_menu_url =  $calling_script."?project=admin&amp;execute_mode=MENU&amp;reportico_session_name=".reportico_session_name()."&amp;token=".newToken();
		$this->configure_project_url =  $calling_script."?execute_mode=PREPARE&amp;xmlin=configureproject.xml&amp;reportico_session_name=".reportico_session_name()."&amp;token=".newToken();
		$this->delete_project_url =  $calling_script."?execute_mode=PREPARE&amp;xmlin=deleteproject.xml&amp;reportico_session_name=".reportico_session_name()."&amp;token=".newToken();
		$this->create_report_url =  $calling_script."?execute_mode=MAINTAIN&amp;xmlin=&amp;reportico_session_name=".reportico_session_name()."&amp;token=".newToken();
...
//echo "set table ";
	...
	function imagequery($imagesql, $width=200)
	{
        ...
        $params .= "&reportico_session_name=".reportico_session_name()."&amp;token=".newToken();

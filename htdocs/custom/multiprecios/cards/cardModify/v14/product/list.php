	...
	for ($i = 1; $i <= $conf->global->PRODUIT_MULTIPRICES_LIMIT; $i++) {
		...
		if (!empty($conf->global->$keyforlabel)) {
            ...
            if($i==1){
                ...
                $labelp = $langs->transnoentitiesnoconv("Selling_price_1");
            }elseif($i==2){

                $labelp = $langs->transnoentitiesnoconv("Selling_price_2");
            }elseif($i==3){

                $labelp = $langs->transnoentitiesnoconv("Selling_price_3");
            }elseif($i==4){

                $labelp = $langs->transnoentitiesnoconv("Selling_price_4");
            }elseif($i==5) {

				$labelp = $langs->transnoentitiesnoconv("Selling_price_5");
			}elseif($i==6){

                $labelp = $langs->transnoentitiesnoconv("Selling_price_6");
            }elseif($i==7){

				$labelp = $langs->transnoentitiesnoconv("Selling_price_7");
			}else{
			...
			//$labelp = $langs->transnoentitiesnoconv("SellingPrice")." ".$i; original
		}

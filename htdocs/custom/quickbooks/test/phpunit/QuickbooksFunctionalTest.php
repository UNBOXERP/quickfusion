...
/**
 * \file    test/phpunit/QuickbooksFunctionalTest.php
 * \ingroup quickbooks
...
/**
 * Class QuickbooksFunctionalTest
 *
 ...
 *
 * @package Testquickbooks
 */
class QuickbooksFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modQuickbooks')->click();
		} else {
			// Disable the module
			$this->byHref('modQuickbooks')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/quickbooks/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('quickbooks/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/quickbooks/admin/about.php');
		$this->authenticate();
		return $this->assertContains('quickbooks/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('quickbookswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modQuickbooks_QuickbooksTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modQuickbooks_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

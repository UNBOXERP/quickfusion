...
<?php
  ...
  if(isset($_SESSION['access_token']) && !empty($_SESSION['access_token'])){
    ...
    echo "<br /> <a class='imgLink' href='/doli15/htdocs/custom/quickbooks/inc/oauth/OAuth_2/OAuth2PHPExample.php'><img style='height: 40px' src='C2QB_white_btn.png'/></a> <br />";
    ...
    echo "<a class='imgLink' href='/doli15/htdocs/custom/quickbooks/inc/oauth/OAuth_2/OAuthOpenIDExample.php'><img style='height: 40px' src='IntuitSignIn-lg.jpg'/></a>";
  }
 ?>

 ...
 * @xmlType TextType
 * @xmlName ExtensionReasonType
 * @var oasis\names\specification\ubl\schema\xsd\CommonExtensionComponents_2\ExtensionReasonType
 */
class ExtensionReasonType extends _2\TextType
{
} // end class ExtensionReasonType

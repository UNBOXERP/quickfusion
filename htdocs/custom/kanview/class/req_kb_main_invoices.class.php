...
//		$sql .= " " . "t.amount AS amount,";  // champ supprimé en Dolibarr 12
		...
		$GROUPBY = "t.rowid,  id,  ' . $refField . ',  t.entity,  t.ref_ext,    t.ref_int,    t.ref_client,  t.type,"

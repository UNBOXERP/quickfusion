...
class ReqKbMainTasks extends CommonObject {
	...
	public function getCodeSQL($_ORDERBY = '', $_isNewOrderBy = true, $_WHERE = '', $_isNewWhere = true, $_HAVING = '', $_isNewHaving = true) {
		...
		$sql .= " FROM ";
		$sql .= "" . MAIN_DB_PREFIX . "projet_task as t    join " . MAIN_DB_PREFIX . "projet on t.fk_projet = " . MAIN_DB_PREFIX . "projet.rowid   left join " . MAIN_DB_PREFIX . "projet_task_time on t.rowid = " . MAIN_DB_PREFIX . "projet_task_time.fk_task";

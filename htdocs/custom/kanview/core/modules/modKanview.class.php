...
class modKanview extends DolibarrModules {
	...
	public function __construct($db) {
		...
		$this->const = array(
				...
				34 => array('KANVIEW_PROSPECTS_ADD_PROSPECTSCLIENTS', 'yesno', '0', 'KANVIEW_PROSPECTS_ADD_PROSPECTSCLIENTS', '0', '0', '0',),
		...
		if (compareVersions(DOL_VERSION, '14.0.0') == -1) { // < 14
			...
			$propale_cloturer					 = '1';
			$propale_cloturer_advance	 = '$user->rights->propal_advance->close';
		}

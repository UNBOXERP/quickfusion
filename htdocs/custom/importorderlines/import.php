...
$sql2  =" INSERT INTO "  . MAIN_DB_PREFIX . "importorderline_hist (fk_commande, date_imported, user_import, file_name, total_registered, not_registered) VALUES ('". $id ."' , current_timestamp, '". $user->id ."', '". $nombre_archivo ."', ". $count3 .", ".$count2." )";

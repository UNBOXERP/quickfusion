...
$arrayofparameters = array(
	'IMPORTORDERLINES_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
	'IMPORTORDERLINES_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
	//'IMPORTORDERLINES_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
	//'IMPORTORDERLINES_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
	//'IMPORTORDERLINES_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
	//'IMPORTORDERLINES_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
	//'IMPORTORDERLINES_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
	//'IMPORTORDERLINES_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
);
...
if ($action == 'updateMask') {
	...
	foreach ($dirmodels as $reldir) {
		$file = dol_buildpath($reldir."core/modules/importorderlines/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
		if (file_exists($file)) {
			$filefound = 1;
	...
	if (!empty($tmpobjectkey)) {
		$constforval = 'IMPORTORDERLINES_'.strtoupper($tmpobjectkey)."_ADDON";
	...
	if ($ret > 0) {
		$tmpobjectkey = GETPOST('object');
		if (!empty($tmpobjectkey)) {
			$constforval = 'IMPORTORDERLINES_'.strtoupper($tmpobjectkey).'_ADDON_PDF';
...
$help_url = '';
$page_name = "ImportorderlinesSetup";
...
$head = importorderlinesAdminPrepareHead();
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "importorderlines@importorderlines");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("ImportorderlinesSetupPage").'</span><br><br>';
					...
					while (($file = readdir($handle)) !== false) {
						if (strpos($file, 'mod_'.strtolower($myTmpObjectKey).'_') === 0 && substr($file, dol_strlen($file) - 3, 3) == 'php') {
							...
							if ($module->isEnabled()) {
								...
								$constforvar = 'IMPORTORDERLINES_'.strtoupper($myTmpObjectKey).'_ADDON';

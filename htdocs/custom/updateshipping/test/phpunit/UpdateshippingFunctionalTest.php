...
/**
 * \file    test/phpunit/UpdateshippingFunctionalTest.php
...
/**
 * Class UpdateshippingFunctionalTest
 *
 ...
 *
 * @package Testupdateshipping
 */
class UpdateshippingFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUpdateshipping')->click();
		} else {
			// Disable the module
			$this->byHref('modUpdateshipping')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/updateshipping/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('updateshipping/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/updateshipping/admin/about.php');
		$this->authenticate();
		return $this->assertContains('updateshipping/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('updateshippingwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modUpdateshipping_UpdateshippingTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUpdateshipping_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

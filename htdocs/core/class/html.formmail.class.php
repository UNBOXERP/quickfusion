				...
				if (is_numeric($this->withfile)) {
					...
					if (count($listofpaths)) {
						foreach ($listofpaths as $key => $val) {
                            ...
                            ************************************ ALAN
                            */
                             if (strpos($file, "expedition") !== false) { //alan
                                // La variable contiene la palabra "expedition"
                                //echo "La variable contiene la palabra 'expedition'.";
                                $formfile_params[4] = str_replace("sending/", "", $formfile_params[4]);
                            }

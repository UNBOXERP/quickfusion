...
<?php } ?>
	...
	<td class="linecolqty nowrap center"><?php $coldisplay++; ?>
<?php

 $sql ="select reel AS st from "  . MAIN_DB_PREFIX . "product_stock where fk_product = " . $line->fk_product;
...
if ((($line->info_bits & 2) != 2) && $line->special_code != 3) {
	...
	print number_format($ty,0,'',',');  // Yes, it is a quantity, not a price, but we just want the formating role of function price
 //print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ty;
} else print '&nbsp;';
print '</td>';
 ?>

 ...
 */
class InterfaceFactureTriggers extends DolibarrTriggers
{
    /**
  ...
  case 'SHIPPING_VALIDATE':
      ...
      $sql ="SELECT date_expedition AS daex, date_valid AS dava  FROM "  . MAIN_DB_PREFIX . "expedition ";
      ...
      $sql2  ="UPDATE "  . MAIN_DB_PREFIX . "expedition  SET  date_expedition = '". $ba3 ."'";
